...
<head>
 <base href="<%=basePath%>">
	...
	<link type="text/css" rel="stylesheet" href="<%=basePath%>style/blue/top.css" />
</head>
...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">代理商管理系统</font> 
        ...
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                <li><a target="desktop" href="javascript:void(0)">
						<img border="0" width="11" height="13" src="style/images/top/msg.gif" /> 
						<span id="msg"></span>
					</a>
				</li>
                <li class="Line"></li>
                <li><a target="desktop" href="javascript:void(0)">
						<img border="0" width="16" height="11" src="style/images/top/mail.gif" /> 
						<span id="mail"></span>
					</a>
				</li>
                <li class="Line"></li>
